...
import com.lambton.note_javadocjuveniles_android.Adapter.SubjectAdapter;
...
public class SubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = NotesDatabase.getInstance(com.lambton.note_javadocjuveniles_android.SubjectActivity.this).getSubjectDao().getAll();
...
//                startActivity(i);
        ...
        createSubject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final AlertDialog.Builder mainDialog = new AlertDialog.Builder(com.lambton.note_javadocjuveniles_android.SubjectActivity.this);
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        NotesDatabase.getInstance(com.lambton.note_javadocjuveniles_android.SubjectActivity.this).getSubjectDao().insert(subject);
                        madapter.list.clear();
                        madapter.list.addAll(NotesDatabase.getInstance(com.lambton.note_javadocjuveniles_android.SubjectActivity.this).getSubjectDao().getAll());
        ...
        madapter = new SubjectAdapter(this,list) {
            ...
            public void deleteAddress(final int pos) {
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //delete item
                        NotesDatabase.getInstance(com.lambton.note_javadocjuveniles_android.SubjectActivity.this).getSubjectDao().delete( list.get(pos));
                        list.remove(pos);
                        recyclerView.getAdapter().notifyDataSetChanged();
                        alertDialog.dismiss();
                    }
            ...
            public void editSubject(final int i) {
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        NotesDatabase.getInstance(com.lambton.note_javadocjuveniles_android.SubjectActivity.this).getSubjectDao().update(subject);
                        alertDialog.dismiss();
                    }
                });
                cross.setOnClickListener(new View.OnClickListener() {
